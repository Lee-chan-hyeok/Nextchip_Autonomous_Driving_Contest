...
- v8s_P2_2211_gc-c3g_140epoch.onnx : pt파일을 변환하고 head를 제거한 onnx 파일
...
- 3. JARVIS MODEL 산출 보고서 : 최종 모델을 산출하는 과정과 프로젝트를 진행하면서 느낀 점을 정리한 문서 및 중간 과정 모델들의 pt파일과 evaluate 결과 txt
...
github repository
: https://github.com/Ino0513/Minions.git